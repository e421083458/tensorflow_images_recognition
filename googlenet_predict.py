...
def main(_):
    ...
    model_path = os.path.join(FLAGS.checkpointDir, "model_googlenet.tfl")
    print(model_path)
    ...
    # print (prediction[0])
    predict_pic = os.path.join("./", "image_1290.jpg")
    img_obj = file_io.read_file_to_string(predict_pic)
    file_io.write_string_to_file("image_1290.jpg", img_obj)

    img = scipy.ndimage.imread("image_1290.jpg", mode="RGB")
    ...
    # Predict
    prediction = model.predict([img])
    predict_label = model.predict_label([img])
    print(prediction)
    print(predict_label)
