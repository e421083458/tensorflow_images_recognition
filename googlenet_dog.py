...
def load_data(dirname="dog_images", resize_pics=(224, 224), shuffle=True,
    one_hot=False):
    dataset_file = os.path.join(dirname, 'dog_images.pkl')
...
X, Y = load_data(dirname="dog_images", one_hot=True, resize_pics=(227, 227))
...
loss = fully_connected(pool5_7_7, 12,activation='softmax')  #设置多少个类别
