...
class googlenet_model:
    __instance = None
    model = None

    def __init__(self,model_path="./model_googlenet.tfl"):
        ...
        network = regression(loss, optimizer='momentum',
                             ...
                             learning_rate=0.001)
        self.model = tflearn.DNN(network, checkpoint_path='model_googlenet',
    ...
    def __new__(cls, *args, **kwd):
        if googlenet_model.__instance is None:
            googlenet_model.__instance = object.__new__(cls, *args, **kwd)
        return googlenet_model.__instance
